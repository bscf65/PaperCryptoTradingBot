...
copy_if_different "$SRC_DIR/btc_eth_sol_coinbase_paper_bot_v14.py" "$TARGET_DIR/btc_eth_sol_coinbase_paper_bot_v14.py"
copy_if_different "$SRC_DIR/analyze_bot_performance_v14.py" "$TARGET_DIR/analyze_bot_performance_v14.py"
copy_if_different "$SRC_DIR/run_btc_bot.sh" "$TARGET_DIR/run_btc_bot.sh"
copy_if_different "$SRC_DIR/README.md" "$TARGET_DIR/README_v14.md"
...
chmod +x btc_eth_sol_coinbase_paper_bot_v14.py analyze_bot_performance_v14.py run_btc_bot.sh
...
Try:
  ...
  ./run_btc_bot.sh btc_eth_sol_coinbase_paper_bot_v14.py --config configs/aggressive_100.json --once
